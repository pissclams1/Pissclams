...
const plans = [
  ...
  { name: "One Property", price: "$49/mo", text: "Get ongoing gap detection, a fresh revenue comparison for every opening, and a ready-to-publish furnished offer for one property.", cta: "Analyze my property", href: "/host", featured: true },
  { name: "Multiple Properties", price: "$99/mo", text: "Monitor up to three properties and prioritize the calendar gaps with the most revenue at risk.", cta: "Analyze my portfolio", href: "/host", featured: false }
];
